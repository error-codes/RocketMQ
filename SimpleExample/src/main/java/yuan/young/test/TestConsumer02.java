...
public class TestConsumer02 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        MessageQueue partition = new MessageQueue("Topic", "broker-a", 0);

        List<MessageExt> messageExts = consumerGroup01.poll();
        for (MessageExt messageExt : messageExts) {
            System.out.println("接收到消息：[QueueID:" + messageExt.getQueueId() + ", " + new String(messageExt.getBody()) + "]");
        }
